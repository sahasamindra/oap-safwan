                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <ul className="custom-stepup ">
                      ...
                      <li className="custom-stepup-item bg-light text-muted">
                        2
                      </li>
                      <li className="custom-stepup-item bg-light text-muted">
                        3
                ...
                <Form>
                  ...
                  <Form.Group className="mb-1">
                    ...
                    <InputGroup className="mb-3">
                      ...
                      <InputGroup.Text
                        id="basic-addon1"
                        onClick={() => onChangeEye("password")}
                      >
                        {eyeToggler ? eyeSlash : eye}
                      </InputGroup.Text>
                    </InputGroup>
                  ...
                  <Form.Group className="mb-1">
                    ...
                    <InputGroup className="mb-1">
                      <FormControl
                        type={typeReChange ? "text" : "password"}
                        className="border-end-0"
                        placeholder="Enter Password Here"
                      />
                      <InputGroup.Text
                        id="basic-addon1"
                        onClick={() => onChangeEye("password_confirmation")}
                      >
                        {eyeReToggler ? eyeSlash : eye}
                      </InputGroup.Text>
                    </InputGroup>
                  </Form.Group>
                  <Form.Check>
                    <Form.Check.Input type="checkbox" />
                    <Form.Check.Label className="custom-form-text-check">
                      Creating An Account Means You're Okey With our{" "}
                    </Form.Check.Label>
                  </Form.Check>
                  <a href="23" className="custom-form-text-check">
                  ...
                  <div className="row mt-2">
                    <Button
                      type="submit"
                      variant="primary"
                      onClick={() => handleToggleVisible("tab1")}
                      className="col-12"
                    >
                      Next
                    </Button>
                ...
                <Form>
                  ...
                  <div className="row mt-2">
                    <Button
                      type="submit"
                      variant="primary"
                      onClick={() => handleToggleVisible("tab2")}
                      className="col-12"
                    >
                      Next
                    </Button>
                  ...
                  <div className="d-flex justify-content-center mt-2">
                    <p className="custom-form-text-check">
                      I Didn't Get Any Code.
                    </p>
                    <a
                      href="23"
                      className="custom-form-text-check text-decoration-none"
                    >
                      RESEND CODE ({counter})
                    </a>
                  </div>
